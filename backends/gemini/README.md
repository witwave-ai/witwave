...
reports whether PreToolUse hooks are actually evaluated: `0`=partial/skeleton (rules loaded but AFC bypasses them —
today's state), `1`=enforcing, `-1`=disabled. See `metrics.py` for the live catalog.
