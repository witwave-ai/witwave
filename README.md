...
Pull a specific image version with a semver tag, e.g. `ghcr.io/witwave-ai/images/harness:0.37.0`. The latest released
...
helm install witwave oci://ghcr.io/witwave-ai/charts/witwave --version 0.37.0 --namespace witwave --create-namespace

# Operator chart — installs the witwave-operator controller and the WitwaveAgent CRD.
helm install witwave-operator oci://ghcr.io/witwave-ai/charts/witwave-operator --version 0.37.0 --namespace witwave-system --create-namespace
```
